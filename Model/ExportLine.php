...
class ExportLine extends \Magento\Framework\Model\AbstractModel implements ExportLineInterface, IdentityInterface
{
    /**
     * @inheritdoc
     */
    const CACHE_TAG = 'rtd_export_line';

    /**
     * @inheritdoc
     */
    protected $_cacheTag = 'rtd_export_line';
