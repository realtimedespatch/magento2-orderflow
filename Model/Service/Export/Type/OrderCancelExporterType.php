...
class OrderCancelExporterType extends \RealtimeDespatch\OrderFlow\Model\Service\Export\Type\ExporterType
{
    /* Exporter Type */
    const TYPE = 'Order';
    ...
    protected function _exportLine($export, $request, $requestLine)
    {
        ...
        try {
            $service->cancelOrder(new \SixBySix\RealtimeDespatch\Entity\Order($incrementId));
