...
use RealtimeDespatch\OrderFlow\Ui\Component\Listing\Columns\ProductExported;
...
/**
 * Class ProductExportedTest
 * @package RealtimeDespatch\OrderFlow\Test\Unit\Ui\Component\Listing\Columns
 */
class ProductExportedTest extends \PHPUnit\Framework\TestCase
{
    protected ProductExported $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = new ProductExported(
            $this->mockContext,
    ...
    public function testPrepareDataSource(): void
    {
        ...
        $this->assertEquals(__('Pending'), $result['data']['items'][0]['product_exported']);
    }
}