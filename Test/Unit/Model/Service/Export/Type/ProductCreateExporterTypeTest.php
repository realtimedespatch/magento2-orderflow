...
use RealtimeDespatch\OrderFlow\Model\Service\Export\Type\ProductCreateExporterType;
...
class ProductCreateExporterTypeTest extends AbstractExporterTypeTest
{
    ...
    protected function setUp(): void
    {
        ...
        $this->exporterType = new ProductCreateExporterType(
