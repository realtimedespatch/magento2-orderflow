...
use RealtimeDespatch\OrderFlow\Model\Service\Import\Type\ShipmentImporterType;
use \RealtimeDespatch\OrderFlow\Model\Service\ShipmentService;

class ShipmentImporterTypeTest extends AbstractImporterTypeTest
{
    ...
    protected function setUp(): void
    {
        ...
        $this->type = new ShipmentImporterType(
