...
use RealtimeDespatch\OrderFlow\Model\DataProvider\ImportDataProvider;
...
class ImportDataProviderTest extends \PHPUnit\Framework\TestCase
{
    protected ImportDataProvider $exportDataProvider;
    ...
    protected function setUp(): void
    {
        ...
        $this->exportDataProvider = new ImportDataProvider(
            $this->name,
            'export_id',
            'id',
            $this->mockReporting,
    ...
    protected function getMockSearchResultItems(): array
    {
        ...
        for ($i = 0; $i < $n; $i++) {
            ...
            $mockImport = $this->getMockBuilder(Import::class)
                ->disableOriginalConstructor()
                ->addMethods(['getCustomAttributes', 'setResponseBody', 'setRequestBody'])
                ->getMock();
