...
use RealtimeDespatch\OrderFlow\Model\DataProvider\ExportDataProvider;
...
class ExportDataProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->exportDataProvider = new ExportDataProvider(
            $this->name,
            'export_id',
            'id',
            $this->mockReporting,
    ...
    protected function getMockSearchResultItems(): array
    {
        ...
        for ($i = 0; $i < $n; $i++) {
            ...
            $mockExport = $this->getMockBuilder(Export::class)
