...
/**
 * Product Update Export Cron.
 *
 * Cron Job to Export Updated Products to OrderFlow.
 *
 * @SuppressWarnings(PHPMD.LongVariable)
 */
class ProductUpdateExport extends ExportCron
{
    /**
    ...
    {
        $products = $this->helper->getUpdateableProducts($website);
