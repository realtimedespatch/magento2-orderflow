...
class ImportLogCleaner
{
     ...
     * @param \RealtimeDespatch\OrderFlow\Model\ImportFactory $requestFactory
     * @param \RealtimeDespatch\OrderFlow\Helper\Log\Cleaning $helper
     */
    public function __construct(
        \Psr\Log\LoggerInterface $logger,
        \RealtimeDespatch\OrderFlow\Model\ImportFactory $factory,
    ...
    public function execute()
    {
        ...
        $cutoff = date('Y-m-d', strtotime('-'.($this->_helper->getImportLogDuration() - 1).' days'));
